...
bool GameBoard::playerIsShadow() const
{
	typedef BoardElement B;
	switch (this->getElementAt(this->getMyPosition())) {
	case B::HERO_SHADOW_DRILL_LEFT:
	case B::HERO_SHADOW_DRILL_RIGHT:
	case B::HERO_SHADOW_LADDER:
	case B::HERO_SHADOW_LEFT:
	case B::HERO_SHADOW_RIGHT:
	case B::HERO_SHADOW_FALL_LEFT:
	case B::HERO_SHADOW_FALL_RIGHT:
	case B::HERO_SHADOW_PIPE_LEFT:
	case B::HERO_SHADOW_PIPE_RIGHT:
		return true;
	default:
		return false;
	}
...
bool GameBoard::hasShadowEnemyAt(const BoardPoint& point) const {
	typedef BoardElement B;
	switch (this->getElementAt(point)) {
	case B::OTHER_HERO_SHADOW_LEFT:
	case B::OTHER_HERO_SHADOW_RIGHT:
	case B::OTHER_HERO_SHADOW_LADDER:
	case B::OTHER_HERO_SHADOW_PIPE_LEFT:
	case B::OTHER_HERO_SHADOW_PIPE_RIGHT:
		return true;
	default:
		return false;
	}
...
bool GameBoard::isNearToEnemy(const BoardPoint& point) const
{
	typedef BoardElement B;
	return isNearToElement(point, B::ENEMY_LADDER)
		|| isNearToElement(point, B::ENEMY_LEFT)
		|| isNearToElement(point, B::ENEMY_RIGHT)
		|| isNearToElement(point, B::ENEMY_PIPE_LEFT)
		|| isNearToElement(point, B::ENEMY_PIPE_RIGHT);
}
